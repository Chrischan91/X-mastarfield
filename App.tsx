        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black overflow-hidden">
                ...
                return (
                  <div 
                    ...
                    style={{
                      ...
                      top: `${initialY}%`,
                      left: `${initialX}%`,
                      backgroundColor: i % 4 === 0 ? '#FFD700' : (i % 4 === 1 ? '#FDB931' : (i % 4 === 2 ? '#B8860B' : '#FFF5E1')),
                      opacity: 0,
                      boxShadow: `0 0 ${size * 1.5}px #FFD700`,
                      animation: `glitter-drift ${duration}s ease-in-out infinite, glitter-twinkle ${2.5 + Math.random() * 3.5}s ease-in-out infinite`,
          ...
          <div className="relative z-10 flex flex-col items-center gap-8 md:gap-12 p-8 max-w-lg text-center">
            <div className="flex flex-col items-center">
               <h1 className="font-cinzel text-4xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-b from-[#FFD700] via-[#FDB931] to-[#B8860B] tracking-[0.1em] leading-tight drop-shadow-[0_0_20px_rgba(255,215,0,0.5)] animate-pulse">
                  X'mastarfield
               </h1>
               <div className="h-[2px] w-32 md:w-64 bg-gradient-to-r from-transparent via-[#FFD700] to-transparent mt-6 shadow-[0_0_15px_#FFD700] opacity-60"></div>
            </div>
            
            <button 
              onClick={startExperience}
              className="group relative flex items-center justify-center px-12 py-5 md:px-20 md:py-8 border border-[#FFD700]/50 bg-black/40 hover:bg-[#FFD700]/10 transition-all duration-500 rounded-sm overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#FFD700]/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
              <span className="font-cinzel text-[#FFD700] text-xl md:text-2xl tracking-[0.5em] font-bold group-hover:scale-105 transition-all duration-500">
                ENTER
              </span>
            </button>
            
            <p className="font-playfair text-[#FFD700]/50 text-[10px] md:text-xs tracking-[0.25em] italic max-w-[280px] leading-loose">
              A high-fidelity 3D Christmas journey.
              <br/>
              <span className="opacity-30">Requires audio and camera permissions.</span>
            </p>
          </div>
          ...
          <style dangerouslySetInnerHTML={{ __html: `
            ...
            @keyframes glitter-twinkle {
              ...
              30%, 70% { opacity: 0.7; transform: scale(1.1); }
